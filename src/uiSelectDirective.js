uis.directive('uiSelect',
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      //autofocus attribute to uisAutofocusAttr directive 
      if (angular.isDefined(tElement.attr('autofocus')))
        tElement.append("<uis-autofocus-attr/>").removeAttr('autofocus');

      //focusOn attribute to uisFocusOnAttr directive
      if (angular.isDefined(tElement.attr('focus-on')))
        tElement.append("<div uis-focus-on-attr='" + tAttrs.focusOn + "'><div/>").removeAttr('focus-on');
